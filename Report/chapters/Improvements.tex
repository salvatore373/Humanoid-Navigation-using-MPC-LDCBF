...
second main peaks correspond to the robot encountering obstacles. When the robot approaches obstacles along its path, it must execute rapid lateral movements to avoid collisions while simultaneously minimizing the error relative to its goal.
