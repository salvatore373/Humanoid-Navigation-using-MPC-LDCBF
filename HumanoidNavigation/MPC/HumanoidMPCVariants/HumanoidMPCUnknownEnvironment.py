...
class HumanoidMPCUnknownEnvironment(HumanoidMPC):
    ...
    def _get_list_c_and_eta(self, loc_x_k: float, loc_y_k: float, glob_theta_k: float, glob_x_k: float, glob_y_k: float):
        # TODO: make changes here
        print(loc_x_k, loc_y_k, glob_theta_k, glob_x_k, glob_y_k)
